...
parser.add_argument('--outnetworkTag', action='store_true', default=True,
...
feature_filename = "/home/dmalawad/Research/EGRC_v2/data/data"+datasetname+"/expression_data.tsv"
edge_filename    = "/home/dmalawad/Research/EGRC_v2/data/data"+datasetname+"/GoldStandard_v2.tsv"
...
if args.outnetworkTag:
    ...
    pickle.dump(allx, open( "../data/dataset/ind.data"+datasetname+".allx", "wb" ) )
    pickle.dump(graphcsc, open( "../data/dataset/ind.data"+datasetname+".csc", "wb" ) )
...
if args.outnetworkSplitTag:
    ...
    pickle.dump(graphcsc1, open( "../data/dataset/ind.data"+datasetname+"_1.csc", "wb" ) )
    pickle.dump(graphcsc2, open( "../data/dataset/ind.data"+datasetname+"_2.csc", "wb" ) )
    pickle.dump(graphcsc3, open( "../data/dataset/ind.data"+datasetname+"_3.csc", "wb" ) )
    pickle.dump(graphcsc23, open( "../data/dataset/ind.data"+datasetname+"_23.csc", "wb" ) )
    pickle.dump(graphcsc13, open( "../data/dataset/ind.data"+datasetname+"_13.csc", "wb" ) )
    pickle.dump(graphcsc12, open( "../data/dataset/ind.data"+datasetname+"_12.csc", "wb" ) )
...
if args.outPCTag:
    ...
    np.save('../data/dataset/data'+datasetname+'_pmatrix_'+str(args.pearson_net)+'.npy', pmatrix)

# Calculate Mutual Information
if args.outMITag:
    mmatrix = mutualMatrix(data, args.mutual_net)
    np.save('../data/dataset/data'+datasetname+'_mmatrix_'+str(args.mutual_net)+'.npy', mmatrix)

# Calculate a random network based on
if args.outRMTag: 
    rmatrix = randomMatrix(data, args.random_net)
    np.save('../data/dataset/data'+datasetname+'_rmatrix_'+str(args.random_net)+'.npy', rmatrix)