...
#    #=========================================================== Writing files============================================
    ...
    second_line = second_line.strip('\n')
    third_line = third_line.strip('\n')
    pooling_path1 =first_line+'/Output/MinCutPooling/'+third_line+'/'
    ...
    namefile=probab_path1+"/ALL_Graphs_MinCutPooling.txt"
    Output_file=open(namefile,"w")



    if third_line!='data4':
        path_test_SP=first_line+'/Output/MinCutPooling/'+third_line+"/SP_TF_G.txt"
        path_test_MI=first_line+'/Output/MinCutPooling/'+third_line+"/MI_TF_G.txt"
        ...
        path_train_SP=first_line+'/Output/MinCutPooling/'+second_line+"/SP_TF_G.txt"
        path_train_MI=first_line+'/Output/MinCutPooling/'+second_line+"/MI_TF_G.txt"
...
#====================================================== Performance evaluation for subgraph prediction based on Mutual information  ====================================================
    ...
    plt.show()
    plt.savefig(first_line+'/figures/'+third_line+'_MinCutPool.png')
