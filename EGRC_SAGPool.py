...
import matplotlib.pyplot as plt
#========================================================================================================================================================
inputfile='/home/dmalawad/Research/EGRC_tool/input.txt'
# Read from the file 
        ...
        def __init__(self, *args, **kwargs):
            ...
            for _ in range(3):
                ...
                self.sag_pools.append(SAGPool(
                    score_gnn=GCN(1),
                    ratio=0.5,
                    score_activation=tf.nn.softmax 
                ))
...
#    #=========================================================== Writing files============================================
    ...
    path = first_line+'/Output/SAGPooling/'+second_line+'/probab'
    ...
    path_test = first_line+'/Output/SAGPooling/'+third_line+'/probab'
    ...
    namefile=probab_path1+"/ALL_Graphs_SAGPooling.txt"
    Output_file=open(namefile,"w")



    if third_line!='data4':
        path_test_SP=first_line+'/Output/SAGPooling/'+third_line+"/SP_TF_G.txt"
        path_test_MI=first_line+'/Output/SAGPooling/'+third_line+"/MI_TF_G.txt"
        ...
        path_train_SP=first_line+'/Output/SAGPooling/'+second_line+"/SP_TF_G.txt"
        path_train_MI=first_line+'/Output/SAGPooling/'+second_line+"/MI_TF_G.txt"
...
#====================================================== Performance evaluation for subgraph prediction based on Mutual information  ====================================================
    ...
    plt.show()
    plt.savefig(first_line+'/figures/'+third_line+'_SAGPool.png')
